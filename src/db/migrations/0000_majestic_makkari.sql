...
--> statement-breakpoint
CREATE INDEX `idx_exam_attempts_user_exam` ON `exam_attempts` (`user_id`,`exam_id`);--> statement-breakpoint
CREATE TABLE `exams` (
	`id` text PRIMARY KEY NOT NULL,
	`code` text NOT NULL,
	`name` text NOT NULL,
...
CREATE UNIQUE INDEX `uq_flashcard_reviews_user_card` ON `flashcard_reviews` (`user_id`,`flashcard_id`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `idx_ms_user_exam_date` ON `mastery_snapshots` (`user_id`,`exam_id`,`snapshot_date`);--> statement-breakpoint
CREATE UNIQUE INDEX `uq_snapshots_user_exam_domain_date` ON `mastery_snapshots` (`user_id`,`exam_id`,`domain_id`,`snapshot_date`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `idx_pp_user_exam_date` ON `pass_probability` (`user_id`,`exam_id`,`computed_at`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `idx_qa_user_topic` ON `question_attempts` (`user_id`,`topic_id`);--> statement-breakpoint
CREATE INDEX `idx_qa_user_question` ON `question_attempts` (`user_id`,`question_id`);--> statement-breakpoint
CREATE INDEX `idx_qa_exam_attempt` ON `question_attempts` (`exam_attempt_id`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `idx_qd_user` ON `question_distractors` (`user_id`);--> statement-breakpoint
CREATE UNIQUE INDEX `uq_distractors_user_q_choice` ON `question_distractors` (`user_id`,`question_id`,`choice_id`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `idx_study_progress_user` ON `study_progress` (`user_id`);--> statement-breakpoint
CREATE UNIQUE INDEX `uq_study_progress_user_topic` ON `study_progress` (`user_id`,`topic_id`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `uq_topic_visits_user_date_topic` ON `study_topic_visits` (`user_id`,`date`,`topic_id`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `idx_tm_user` ON `topic_mastery` (`user_id`);--> statement-breakpoint
CREATE UNIQUE INDEX `uq_topic_mastery_user_topic` ON `topic_mastery` (`user_id`,`topic_id`);--> statement-breakpoint
CREATE TABLE `topics` (
	`id` text PRIMARY KEY NOT NULL,
	`domain_id` text NOT NULL,
	`title` text NOT NULL,
...
--> statement-breakpoint
CREATE INDEX `idx_topics_domain_id` ON `topics` (`domain_id`);--> statement-breakpoint
CREATE TABLE `users` (
