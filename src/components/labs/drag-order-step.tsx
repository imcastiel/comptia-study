    ...
    <>
      ...
      {submitted && (
        ...
        >
          <p
            ...
            style={{ color: isAllCorrect ? 'var(--apple-green)' : 'var(--apple-red)' }}
          >
      ...
      {!submitted && (
        <button
          ...
          className="w-full py-3 rounded-[12px] text-[14px] font-semibold bg-[var(--apple-blue)] text-white hover:opacity-90 transition-opacity"
        >
          Check Order
        </button>
      )}
