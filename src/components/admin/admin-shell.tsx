...
import { LayoutDashboard, Sparkles, FolderOpen, Layers, Download, ArrowLeft, BookMarked, Terminal, Target, HeartPulse } from 'lucide-react'
import { cn } from '@/lib/utils'

const NAV = [
  { href: '/admin', icon: LayoutDashboard, label: 'Dashboard' },
  { href: '/admin/coverage', icon: Target, label: 'Coverage' },
